...
from yolo3.model import tiny_yolo_body, yolo_loss, preprocess_true_boxes, yolo_head, box_iou
...
class TrainingProcess:
    ...
    def train(self, global_model):
        ...
        #load the global model and extract weights from it
        self.local_model = keras.models.load_model(global_model, custom_objects= {'yolo_head': yolo_head, 'tf':tf, 'box_iou': box_iou})
        while True:
